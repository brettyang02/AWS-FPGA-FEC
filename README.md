...
The design is based on the PAM-4 200G Ethernet design by Mr. Richard Barrie, which is open-sourced on his GitHub repo [FPGA-FEC](https://github.com/richard259/FPGA-FEC). We would like to thank Mr. Barrie for his amazing work.


## Repo structure

- `docs/`: archives all documentation related to the project. It contains:
