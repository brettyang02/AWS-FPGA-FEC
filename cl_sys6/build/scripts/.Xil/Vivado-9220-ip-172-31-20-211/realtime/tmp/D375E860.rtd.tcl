...
set genomeRtd $env(RT_TMP)/D375E860.rtd
set parallel_map_command "rt::do_reinfer_area_combined 1"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {case__51_clk_mmcm_a_mmcm_drp__GD}]"
...
set genomeName [subst -nocommands -novariables {case__51_clk_mmcm_a_mmcm_drp__GD}]
