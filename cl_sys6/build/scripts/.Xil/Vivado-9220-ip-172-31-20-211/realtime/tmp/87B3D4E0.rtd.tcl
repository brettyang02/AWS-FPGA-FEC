...
set genomeRtd $env(RT_TMP)/87B3D4E0.rtd
set parallel_map_command "rt::do_reinfer_area_combined 1"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {random_noise__parameterized42__GB0}]"
...
set genomeName [subst -nocommands -novariables {random_noise__parameterized42__GB0}]
