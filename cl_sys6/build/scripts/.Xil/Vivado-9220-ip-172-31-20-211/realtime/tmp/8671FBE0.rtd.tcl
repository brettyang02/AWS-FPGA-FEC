...
set genomeRtd $env(RT_TMP)/8671FBE0.rtd
set parallel_map_command "rt::do_reinfer_area_combined 1"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {clk_mmcm_a_mmcm_drp__GB1}]"
...
set genomeName [subst -nocommands -novariables {clk_mmcm_a_mmcm_drp__GB1}]
