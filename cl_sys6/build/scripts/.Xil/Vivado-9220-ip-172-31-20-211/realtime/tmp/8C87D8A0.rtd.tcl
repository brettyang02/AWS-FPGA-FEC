...
set genomeRtd $env(RT_TMP)/8C87D8A0.rtd
set parallel_map_command "rt::do_reinfer_area_combined 1"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {parallel_sys6_PAM6__GCB0}]"
...
set genomeName [subst -nocommands -novariables {parallel_sys6_PAM6__GCB0}]
