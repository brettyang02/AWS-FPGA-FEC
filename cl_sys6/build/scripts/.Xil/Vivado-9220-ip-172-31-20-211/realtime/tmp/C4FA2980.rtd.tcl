...
set genomeRtd $env(RT_TMP)/C4FA2980.rtd
set parallel_map_command "rt::do_reinfer_area_combined 1"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {sys6_PAM6_top__parameterized3__GC0}]"
...
set genomeName [subst -nocommands -novariables {sys6_PAM6_top__parameterized3__GC0}]
