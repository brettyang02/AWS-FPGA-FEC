...
set genomeRtd $env(RT_TMP)/D5739820.rtd
set parallel_map_command "rt::do_techmap_steps"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {datapath__3685_parallel_sys6_PAM6__GD}]"
...
set genomeName [subst -nocommands -novariables {datapath__3685_parallel_sys6_PAM6__GD}]
