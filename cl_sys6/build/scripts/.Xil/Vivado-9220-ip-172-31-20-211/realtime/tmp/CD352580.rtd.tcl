...
set genomeRtd $env(RT_TMP)/CD352580.rtd
set parallel_map_command "rt::do_reinfer_area_combined 1"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {datapath__3686_parallel_sys6_PAM6__GD}]"
...
set genomeName [subst -nocommands -novariables {datapath__3686_parallel_sys6_PAM6__GD}]
