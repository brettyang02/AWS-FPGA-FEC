...
if __name__ == "__main__":
    ...
    generate_pam6_noise(19.0, "noise19dB_sep24.mem", symbol_separation=24)
    generate_pam6_noise(18.0, "noise18dB_sep24.mem", symbol_separation=24)
    generate_pam6_noise(17.0, "noise17dB_sep24.mem", symbol_separation=24)
    generate_pam6_noise(16.0, "noise16dB_sep24.mem", symbol_separation=24)
    generate_pam6_noise(15.0, "noise15dB_sep24.mem", symbol_separation=24)
    generate_pam6_noise(14.0, "noise14dB_sep24.mem", symbol_separation=24)
    generate_pam6_noise(13.0, "noise13dB_sep24.mem", symbol_separation=24)
    generate_pam6_noise(12.0, "noise12dB_sep24.mem", symbol_separation=24)
    generate_pam6_noise(11.0, "noise11dB_sep24.mem", symbol_separation=24)
