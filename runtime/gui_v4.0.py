...
class FpgaMonitorApp:
    ...
    def _build_ui(self):
        ...
        self.combo_target_stat.set("Post-FEC Errors"); self.combo_target_stat.grid(row=3, column=1, sticky="ew", pady=5)

        ctk.CTkLabel(input_grid, text="N Int:").grid(row=3, column=2, sticky="w", padx=(10, 0))
        self.entry_n_int = ctk.CTkEntry(input_grid, width=60); self.entry_n_int.insert(0, "1")
        self.entry_n_int.grid(row=3, column=3, sticky="w", pady=2)
    ...
    def init_fpga(self):
        ...
        self.fpga.poke(ADDR_N_INT, self.current_n_int); self.fpga.poke(ADDR_CTRL, CTRL_SYNC_EN)
    ...
    def manual_reset_btn(self):
        try:
            ...
            self.current_n_int = int(self.entry_n_int.get())
